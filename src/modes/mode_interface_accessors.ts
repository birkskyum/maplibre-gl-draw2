 ...
 * See [draw.actionalbe](https://github.com/mapbox/maplibre-gl-draw/blob/main/API.md#drawactionable) for a list of possible actions. All undefined actions are set to **false** by default
